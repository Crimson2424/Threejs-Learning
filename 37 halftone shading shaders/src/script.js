...
materialParameters.shadowColor = '#8e198b'
...
gui.addColor(materialParameters, 'shadowColor').onChange(()=> material.uniforms.uShadowColor.value.set(materialParameters.shadowColor))

gui.add(material.uniforms.uLightRepetitions, 'value').min(1).max(300).step(1)
gui.addColor(materialParameters, 'lightColor').onChange(()=> material.uniforms.uLightColor.value.set(materialParameters.lightColor))
