...
gui.add(uniforms.uPositionFrequency, 'value', 0, 1, 0.01).name('uPositionFrequency')
...
gui.addColor(debugObject, 'colorWaterDeep').onChange(()=> uniforms.uColorWaterDeep.value.set(debugObject.ccolorWaterDeep))
